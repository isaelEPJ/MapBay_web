...
class TripChartCard extends StatefulWidget {
  TripChartCard({Key? key}) : super(key: key);

  @override
  _TripChartCardState createState() => _TripChartCardState();
}

class _TripChartCardState extends State<TripChartCard> {
  @override
